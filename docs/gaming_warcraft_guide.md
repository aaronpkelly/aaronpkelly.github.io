...
https://www.wowhead.com/guides/battle-for-azeroth-leveling-and-consumables
http://www.wowhead.com/leveling-from-100-110-in-legion
https://www.wowhead.com/monk-leveling-guide
...
## Seasonal even buffs
Choose one, they don't stack:
Darkmoon carousel "Whee!" buff +10% XP
OR
"Darkmoon Top Hat" +10% XP

## Potions
### Draught of ten lands
It's a potion that's coming in the next patch, +10%XP:
https://ptr.wowhead.com/item=166750/draught-of-ten-lands#comments

### Elixir of the Rapid mind
+300%XP. Expensive. Use before turning in a lot of quests

## Gems
Insightful Rubellite, cheap gem that can be bought off AH. +5%XP

## Resting
Always rest. +200% XP.

## Zone XP buffs
Some zones offer XP buffs during the levelling process.

## Class buffs
A levelling monk (<=lvl 90)can get the Enlightenment buff by doing their class daily. +50%XP.

## Speed
- Do I have https://www.wowhead.com/item=81354/reins-of-the-azure-water-strider

## Heirloom gear
Gear that scales with you as you level. Only works up to lvl 110.
...
If the dungeons are WOTLK... the turn-in location is the fountain in *OLD DALARAN*, not new Dalaran. You'll need to either:
- get a portal from new Dalaran to Wyrmrest temple, and then fly
- catch a ship from Stormwind to Borean Tundra, then fly
