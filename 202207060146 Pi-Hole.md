Tags: #publish #pi-hole #ad-blocking
...
Your router needs to be able to let set a custom DNS server, which is needed in order to point all DNS requests to the [202207060146 Pi-Hole](202207060146%20Pi-Hole.md).
